	...
	return (
		<main className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center">
			<header className="w-full py-8 flex justify-center items-center bg-primary text-primary-foreground shadow-lg">
				...
				<h1 className="text-4xl font-bold tracking-tight ml-4">
			...
			<Card className="mt-12 mb-8 w-full max-w-3xl text-center animate-fade-in">
				<CardHeader>
					...
					<CardDescription>
						AI-powered recommendations tailored to your style, skill, and goals.
						Visualize, learn, and win more games.
					</CardDescription>
				</CardHeader>
				<CardContent>
			...
			<Card className="about w-full max-w-3xl mb-8 text-left">
				...
				<CardContent>
					<ol className="list-decimal list-inside space-y-2">
						...
						<li>
							Get a curated list of openings with explanations and win rates.
						</li>
			...
			<footer className="w-full py-6 flex flex-col items-center bg-secondary text-secondary-foreground mt-auto">
				<p className="text-sm">
					Built with ShadCN, Tailwind, and Next.js. Responsive, accessible, and
					recruiter-ready.
				</p>
				<a
					href="https://github.com/a/chess-opening-recommender-web"
